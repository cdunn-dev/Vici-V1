  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="grid w-full grid-cols-3 mb-6 shadow-md rounded-lg bg-gradient-to-r from-indigo-400/60 via-purple-400/60 to-pink-400/60 px-0.5 py-1">
          <TabsTrigger value="current" className="py-3 font-medium rounded-md">
            <span className="flex items-center gap-2">
              <Calendar className="h-4 w-4" />
              This Week
            </span>
          </TabsTrigger>
          <TabsTrigger value="overall" className="py-3 font-medium rounded-md">
            <span className="flex items-center gap-2">
              <BarChart className="h-4 w-4" />
              Training Plan
            </span>
          </TabsTrigger>
          <TabsTrigger value="stored" className="py-3 font-medium rounded-md">
            <span className="flex items-center gap-2">
